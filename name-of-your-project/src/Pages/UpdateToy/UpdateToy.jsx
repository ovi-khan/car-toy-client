    ...
    <div className="bg-[#F4F3F0] lg:p-24 mt-10">
      ...
      >
        ...
        <select
          name="select"
          defaultValue={select}
          className="mt-5 mb-20 bg-pink-500 rounded p-2"
        >
          <option value="Sports Cars" className="bg-orange-300">
            Sports Cars
          </option>
          <option value="Truck" className="bg-orange-100">
            Truck
          </option>
          <option value="Off-Road Vehicles" className="bg-orange-400">
            Off-Road Vehicles
          </option>
        </select>
